                ...
                <div class="card col s12  grey lighten-2" style="padding: 15px">
                    ...
                    <form class="input-field col s12" method="post" action="../Controles/server.php">
                        <div class="input-field">
                            <input type="text" hidden="true" value="<?php echo $_GET['msg'] ?>" name="idmaq"/>
                            <div class="row">
                                <div class="input-field col s6">
                                    <input type="text" value="<?php echo $maq['nomelab'] . $maq['nome'] ?>" disabled="true" name="nomeMaq"/>
                                    <label>Maquina:</label>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="input-field col s6">
                                    <select name="statsmaq">                             
                                        <option value="Funcionando">Funcionando</option>
                                        <option selected="" value="Problema!">Problema</option>
                                    </select>
                                    <label>Situação: *</label>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <button type="submit" class="btn" name="btInsereEventMaq">Confirmar</button>
                            </div>
                        </div>
                    </form>
                </div>
