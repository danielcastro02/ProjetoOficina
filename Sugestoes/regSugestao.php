        ...
        <div class="row">
            <div class="container  col s4 push-s4 center hide-on-med-and-down">
                <div class="card col s12  grey lighten-2" style="padding: 15px">
                    <h4 class=" col s12 card  grey lighten-2 z-depth-3" style="padding: 15px">Enviar Sugestão</h4>
                    <form class="input-field col s12" method="post" action="../Controles/server.php">
                        <div class="input-field">
                            <input type="text" hidden="true" value="<?php echo $_GET['page'] ?>" name="pagina"/>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <button type="submit" class="btn" name="btRegSugest">Confirmar</button>
                            </div>
                        </div>
                    </form>
                </div>
